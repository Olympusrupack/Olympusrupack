...
$lang = array_merge($lang, array(
	...
	'BUMPED_BY'							=> 'Последний раз поднималось %1$s в %2$s',
	'BUMP_TOPIC'						=> 'Поднять тему',

	'CODE'								=> 'Код',

	'DELETE_TOPIC'						=> 'Удалить тему',
	'DOWNLOAD_NOTICE'					=> 'У вас нет прав, необходимых для просмотра или скачивания вложений из этого сообщения.',

	'EDITED_TIMES_TOTAL'				=> 'Последний раз редактировалось %1$s в %2$s, всего редактировалось %3$d раз(а)',
	'EDITED_TIME_TOTAL'					=> 'Последний раз редактировалось %1$s в %2$s, всего редактировалось %3$d раз',
	...
	'MAKE_GLOBAL'						=> 'Сделать общим объявлением',
	'MAKE_NORMAL'						=> 'Сделать обычной',
	'MAKE_STICKY'						=> 'Сделать прикрепленной',
