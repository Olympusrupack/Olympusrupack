...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Любой текст, включая символы любого языка, числа и так далее. Не следует применять эту лексему в тегах HTML. Вместо этого используйте лексемы IDENTIFIER или SIMPLETEXT.',
