...
$lang = array_merge($lang, array(
	...
	'ACP_LANGUAGE_PACKS_EXPLAIN'	=> 'Здесь вы можете устанавливать/удалять языковые пакеты',
	...
	'INVALID_LANGUAGE_PACK'		=> 'Выбранный языковой пакет, скорее всего, повреждён. Проверьте языковой пакет и загрузите его на сервер повторно, если необходимо.',
	...
	'NO_REMOVE_DEFAULT_LANG'		=> 'Вы не можете удалить языковой пакет, используемый по умолчанию.<br />Если вы хотите удалить этот языковой пакет, сначала измените язык конференции по умолчанию.',
	...
	'WRONG_LANGUAGE_FILE'		=> 'Выбранный языковой файл повреждён или не существует.',
));
