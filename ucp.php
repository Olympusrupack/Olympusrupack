...
$lang = array_merge($lang, array(
	...
	'NOT_MOVED_MESSAGE'				=> 'Из-за того, что папка заполнена, 1 личное сообщение находится в ожидании.',
	'NOT_MOVED_MESSAGES'			=> 'Из-за того, что папка заполнена, ожидающих личных сообщений: %d.',
	'NO_ACTION_MODE'				=> 'Не выбрано действие для сообщения.',
	'NO_AUTHOR'						=> 'У письма не указан автор',
