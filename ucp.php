...
$lang = array_merge($lang, array(
	...
	'CONFIRM_EXPLAIN'         		=> 'Для предотвращения автоматических регистраций администратор форумов требует ввода кода подтверждения. Код показан на картинке, которая находится ниже. Если вы не видите код на картинке, то обратитесь к %sадминистратору%s.', // Кусок этой фразы переводили в posting.php, оттуда и нужно взять... нет возможности, провайдер ... эмм... ну вы поняди
	...
	'DEFAULT_ACTION'         		=> 'Действия по умолчанию',
	...
	'DELETE_MESSAGE_CONFIRM'   		=> 'Вы уверены что хотите удалить данное сообщение?', // Не стал употреблять "личное", т.к. выше в случае удаления множества ЛС о их личности ничего не говорится
	...
	'DEMOTE_SELECTED'         		=> 'Отказаться от руководства', // Дословно: понизить выбранное в должности :)
