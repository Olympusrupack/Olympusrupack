...
$lang = array_merge($lang, array(
	...
	'BOTS_EXPLAIN'		=> 'Боты — это автономные агенты, обычно используемые поисковыми системам для обновления своих баз данных. Поскольку боты редко должным образом работают с сессиями, они могут нарушить счётчики посещений, увеличить нагрузку на сервер и иногда неправильно проиндексировать сайт. Здесь вы можете создать пользователей особого типа в целях предотвращения подобных проблем.',
	...
	'BOT_VIS'			=> 'Бот видим',
	'BOT_VIS_EXPLAIN'	=> 'Разрешить отображение бота на странице «Кто сейчас на конференции».',
