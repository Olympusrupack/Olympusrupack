...
$lang = array_merge($lang, array(
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Только администраторы и модераторы смогут видеть и изменять это поле. Если включено, то поле будет отображаться лишь в профилях пользователей.',
