...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> 'При включении этой опции пользователи получат форму быстрого ответа для этого форума. Если в функциях конференции глобальная опция быстрого ответа отключена, или если в форуме отключена публикация сообщений, то форма быстрого ответа не будет отображена, даже если здесь она будет включена.',
