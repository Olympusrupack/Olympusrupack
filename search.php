...
$lang = array_merge($lang, array(
	...
	'RESULT_SORT'			=> 'Упорядочить по',
	'RETURN_FIRST'			=> 'Показывать первые',

	'SEARCHED_FOR'			=> 'Использованы для поиска',
	'SEARCHED_TOPIC'		=> 'Найденная тема',
	...
	'SEARCH_FORUMS_EXPLAIN'		=> 'Выберите форум или форумы, в которых будете искать. Вы можете выбрать несколько форумов или категорий, используя подходящую для вашего компьютера и браузера комбинацию клавиш и мыши, например Ctrl+Left. При поиске по всем подфорумам рекомендуется выбрать родительскую категорию в целях ускорения.',
	...
	'TOO_FEW_AUTHOR_CHARS'		=> 'Вы должны ввести не менее %d символов в имени автора.',
));
