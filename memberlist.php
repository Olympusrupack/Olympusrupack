...
$lang = array_merge($lang, array(
	...
	'EMAIL_BODY_EXPLAIN'	=> 'Сообщение будет отправлено в виде простого текста, не включайте в него HTML или BBCode. В качестве обратного адреса будет показываться ваш адрес e-mail.',
	'EMAIL_DISABLED'		=> 'Извините, но все функции, связанные с отправкой e-mail, были отключены.',
	'EMAIL_SENT'			=> 'Сообщение было отправлено.',
	'EMAIL_TOPIC_EXPLAIN'	=> 'Сообщение будет отправлено в виде простого текста, не включайте в него HTML или BBCode. Обратите внимание, что информация о теме уже включена в сообщение. В качестве обратного адреса будет показываться ваш адрес e-mail.',
	'EMPTY_ADDRESS_EMAIL'	=> 'Вы должны указать правильный адрес e-mail получателя.',
	...
	'LOGIN_EXPLAIN_LEADERS'		=> 'Для просмотра списка команды форума вы должны быть авторизованы.',
	...
	'NO_EMAIL'				=> 'Вам не разрешено посылать e-mail этому пользователю.',
	...
	'USER_ONLINE'			=> 'В сети',
	'USER_PRESENCE'			=> 'Присутствие в конференции',
