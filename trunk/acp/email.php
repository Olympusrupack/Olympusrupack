...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> 'Здесь вы можете отправить email-сообщения всем пользователям или членам определённой группы. Для этого email-сообщение будет отправлено на административный адрес, с BCC: всем получателям. Если вы отправляете сообщения большой группе людей, будьте терпеливы и не останавливайте процесс отправки до его полного завершения. Длительное время отправки является нормальным при массовой рассылке, вы будете уведомлены о завершении операции',
	'ALL_USERS'						=> 'Все пользователи',

	'COMPOSE'				=> 'Создать',

	'EMAIL_SEND_ERROR'		=> 'При отправке сообщения произошла одна или несколько ошибок. Проверьте %sЖурнал ошибок%s для получения более полной информации.',
