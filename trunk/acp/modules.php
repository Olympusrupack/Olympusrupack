...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Здесь вы можете управлять всеми типами модулей. Обратите внимание, что Административный раздел имеет трехуровневую структуру меню (Категория-> Категория-> Модуль), в результате чего подразделы имеют двухуровневую структуру меню (Категория-> Модуль), которая должна быть сохранена. Также учтите, что вы может заблокировать доступ самому себе, если вы деактивируете или удалите модули, отвечающие за управление модулями.',
	...
	'CANNOT_REMOVE_MODULE'	=> 'Невозможно удалить модуль, имеющий дочерние модули. Удалите или переместите все дочерние модули перед выполнением этого действия.',
	'CATEGORY'				=> 'Категория',
	...
	'NO_CATEGORY_TO_MODULE'	=> 'Невозможно объявить категорию модулем. Удалите/переместите все дочерние модули перед выполнением этого действия.',
