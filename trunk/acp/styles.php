...
$lang = array_merge($lang, array(
	...
	'DELETE_STYLE_EXPLAIN'		=> 'Здесь вы можете удалить выбранный стиль. Вы не сможете удалить сразу все элементы стиля. Они должны удаляться отдельно через соответствующие формы. Будьте осторожны, удаление нельзя будет отменить.',
