...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_EXPLAIN'	=> 'Здесь вы можете блокировать пользователям доступ по именам, email или IP-адресам. Эти методы не позволят пользователю попасть ни в один из разделов конференции. При желании вы можете оставить короткую надпись (до 3000 символов) с описанием причины закрытия доступа, которая будет отображаться в логе администратора. Также можно указать продолжительность закрытия доступа. Если вы хотите, чтобы блокировка закончилась в определённый день, а не через установленный промежуток времени, то введите дату в формате <kbd>ГГГГ-ММ-ДД</kbd> под списком «Продолжительность закрытия доступа», предварительно выбрав в этом списке опцию <span style="text-decoration: underline;">До даты</span>.',
