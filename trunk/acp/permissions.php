...
$lang = array_merge($lang, array(
	...
	'APPLY_PERMISSIONS_EXPLAIN'	=> 'Права доступа и роль, определенные для данного объекта, будут применены только к этому объекту и всем отмеченным объектам.', // ???
	...
	'ROLE_ASSIGNED_TO'				=> 'назначена роль %s',
	...
	'ROLE_NOT_ASSIGNED'				=> 'Роль не не была назначена.',
