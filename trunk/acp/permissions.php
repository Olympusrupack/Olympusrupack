...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Маски прав доступа используются для просмотра действующих прав доступа, назначенных на пользователей, модераторов (локальных и супермодераторов), администраторов и на форумы.</p>
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Здесь вы можете назначать администраторские права пользователям или группам. Все пользователи с администраторскими правами могут входить в панель администрирования.',
