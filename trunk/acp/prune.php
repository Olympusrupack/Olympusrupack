...
$lang = array_merge($lang, array(
	...
	'SELECT_USERS_EXPLAIN'		=> 'Введите здесь конкретные имена пользователей, в этом случае заданные выше критерии не будут использованы. Примечание: основатели не могут быть удалены или отключены.',
