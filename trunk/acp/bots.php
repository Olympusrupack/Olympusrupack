...
$lang = array_merge($lang, array(
	...
	'BOTS_EXPLAIN'		=> '«Боты», «пауки» или «ползуны»  — это автоматические агенты, обычно используемые поисковыми системам для обновления своих баз данных. Поскольку они редко должным образом работают с сессиями, они могут исказить счётчики посещений, увеличить нагрузку на сервер и иногда неправильно проиндексировать сайт. Здесь вы можете создать пользователей особого типа в целях преодоления подобных проблем.',
	...
	'BOT_NAME_TAKEN'	=> 'Указанное имя уже используется на конференции и не может быть использовано этим ботом.',
	'BOT_NEVER'			=> 'Никогда',
