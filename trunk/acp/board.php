...
$lang = array_merge($lang, array(
	...
	'FULL_FOLDER_ACTION_EXPLAIN'=> 'Действие по умолчанию, применяемое для переполненной папки пользователя, в случае, если производимое пользователем действие для папки неприменимо. Единственным исключением является папка «Отправленные сообщения», для которой действием по умолчанию всегда является удаление старых сообщений.',
