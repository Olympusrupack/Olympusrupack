...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_GD_FONTS_EXPLAIN'				=> 'Позволяет управлять количеством используемых форм для отображения символов. Вы можете использовать формы по умолчанию или добавить изменённые символы. Также возможно добавление символов в нижнем регистре.',
