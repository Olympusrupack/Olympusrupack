...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'MIN_TIME_REG_EXPLAIN'		=> 'Регистрационная форма не может быть отправлена ранее, чем через указанное время.',
	'MIN_TIME_TERMS'			=> 'Минимальное время для согласия с условиями регистрации',
	'MIN_TIME_TERMS_EXPLAIN'	=> 'Условия регистрации не могут быть приняты ранее, чем через указанное время.',
...
$lang = array_merge($lang, array(
	...
	'FORM_TIME_MIN_EXPLAIN'			=> 'Отправка формы раньше, чем через указанное время, будет проигнорирована конференцией. Установите 0 для отключения этой функции.',
