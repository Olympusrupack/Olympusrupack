...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUEUE_TRIGGER_EXPLAIN'	=> 'Сообжения зарегистрированных пользователей могут быть поставлены в очередь для одобрения, если число оставленных ими сообщений меньше указанного ниже значения. Данная настройка не связана со значением права доступа относительно одобрения тем/сообщений.',
