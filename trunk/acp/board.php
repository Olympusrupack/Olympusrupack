...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'Здесь показывается, как будет выглядеть код подтверждения при использовании текущих настроек. Используйте кнопку «Предпросмотр» для обновления картинки.',
	...
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Позволяет пользователям запрашивать новый код подтверждения, если они не смогли его прочесть при регистрации.',
));
