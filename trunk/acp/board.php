...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Формат даты совпадает с параметрами функции <code>date</code> языка PHP.',
	...
	'SITE_NAME'						=> 'Имя сайта',
	'SYSTEM_DST'					=> 'Учесть переход на летнее время',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_FORUM_NOTIFY'		=> 'Разрешить следить за форумом',
	'ALLOW_NAME_CHANGE'			=> 'Разрешить смену имени пользователя',
	'ALLOW_NO_CENSORS'			=> 'Разрешить отключение цензора слов',
	'ALLOW_NO_CENSORS_EXPLAIN'	=> 'Пользователи смогут по выбору отключать автоматический цензор слов в обычных и личных сообщениях.',
	...
	'ALLOW_TOPIC_NOTIFY'		=> 'Разрешить следить за темой',
...
$lang = array_merge($lang, array(
	...
	'MIN_AVATAR_SIZE_EXPLAIN'		=> '(Высота x Ширина в пикселях)',
));

// Message Settings
$lang = array_merge($lang, array(
	'ACP_MESSAGE_SETTINGS_EXPLAIN'		=> 'Здесь вы можете задать все настройки по умолчанию для личных сообщений',

	'ALLOW_BBCODE_PM'			=> 'Разрешить BBCode в личных сообщениях',
	'ALLOW_FLASH_PM'			=> 'Разрешить использование тега BBCode <code>[FLASH]</code>',
	'ALLOW_FORWARD_PM'			=> 'Разрешить пересылку личных сообщений',
	'ALLOW_IMG_PM'				=> 'Разрешить использование тега BBCode <code>[IMG]</code>',
	'ALLOW_MASS_PM'				=> 'Разрешить отправку личных сообщений нескольким пользователям или группам пользователей',
	'ALLOW_PRINT_PM'			=> 'Разрешить печатный вид в личных сообщениях',
	'ALLOW_QUOTE_PM'			=> 'Разрешить цитаты в личных сообщениях',
	'ALLOW_SIG_PM'				=> 'Разрешить подписи в личных сообщениях',
	'ALLOW_SMILIES_PM'			=> 'Разрешить смайлики в личных сообщениях',
	'BOXES_LIMIT'				=> 'Максимальное количество личных сообщений в папке',
	'BOXES_LIMIT_EXPLAIN'		=> 'Пользователи не смогут сохранять больше, чем указанное количество сообщений, в каждой из папок для личных сообщений. Установите 0 для снятия ограничений.',
	'BOXES_MAX'					=> 'Максимальное количество папок для личных сообщений',
	'BOXES_MAX_EXPLAIN'			=> 'По умолчанию пользователи не смогут создавать больше указанного количества папок для личных сообщений.',
...
$lang = array_merge($lang, array(
	...
	'EDIT_TIME_EXPLAIN'				=> 'Ограничивает время, в течение которого доступно редактирование нового сообщения. Установите 0 для отключения этой функции.',
	'FLOOD_INTERVAL'				=> 'Задержка флуда',
	'FLOOD_INTERVAL_EXPLAIN'		=> 'Количество секунд, которое должно пройти между двумя сообщениями пользователя. Чтобв разрешить пользователям игнорировать это ограничение, установите им соответствующие права.',
...
$lang = array_merge($lang, array(
	...
	'MAX_SIG_SMILIES'				=> 'Максимальное количество смайликов в подписи',
	...
	'MAX_SIG_URLS'					=> 'Максимальное количество ссылок в подписи',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> 'Определяет, должен ли пользователь получить немедленный доступ к конференции, или для этого требуется подтверждение регистрации. Вы можете также полностью отключить новую регистрацию пользователей.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'USERNAME_ALPHA_SPACERS'	=> 'Буквенно-цифровые и пробелы',
	'USERNAME_ASCII'			=> 'ASCII (без международного юникода)',
	'USERNAME_LETTER_NUM'		=> 'Любая буква и цифра',
	'USERNAME_LETTER_NUM_SPACERS'	=> 'Любая буква, цифра и пробел',
	'USERNAME_CHARS'			=> 'Ограничения на символы в имени пользователя',
	'USERNAME_CHARS_ANY'		=> 'Любые символы',
	'USERNAME_CHARS_EXPLAIN'	=> 'Символы, которые могут быть использованы в именах пользователей, исключая пробел, -, +, _, [ и ]',
...
$lang = array_merge($lang, array(
	...
	'YES_ONLINE_TRACK'				=> 'Включить тотбражение информации о пользователе «в сети/не в сети»',
	...
	'YES_READ_MARKING_EXPLAIN'		=> 'Сохранять информацию о статусе «прочитано/не прочитано» в базе данных, а не в куки.',
));

// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBB поддерживает расширения аутентификации, или модули. Они позволяют вам установить способ аутентификации пользователей при их при входе на конференцию. По умолчанию доступны три модуля: DB, LDAP and Apache. Не все методы требуют дополнительной информации, поэтому заполняйте только те поля, которые необходимы для выбранного метода.',
	...
	'LDAP_PASSWORD_EXPLAIN'			=> 'Оставьте поле пустым для анонимного доступа. В противном случае укажите пароль для указанного выше пользователя. <strong>ВНИМАНИЕ:</strong> Этот пароль будет сохранён в виде обычного текста в базе данных, и будет видем всем, кто имеет к ней доступ.',
...
$lang = array_merge($lang, array(
	...
	'CHECK_DNSBL'					=> 'Проверить IP через чёрный список DNS (DNS Blackhole List)',
	'CHECK_DNSBL_EXPLAIN'			=> 'Если включено, IP-адрес пользователя будет проверен с помощью следующих служб  DNSBL при регистрации или отправке сообщений: <a href="http://spamcop.net">spamcop.net</a>, <a href="http://dsbl.org">dsbl.org</a> и <a href="http://spamhaus.org">spamhaus.org</a>. Эта процедура может занять некоторое время, в зависимости от конфигурации сервера. В случае замедления работы сервера или большого количества ложных положительных результатов рекомендуется отключить эту проверку.',
	'CLASS_B'						=> 'A.B',
	'CLASS_C'						=> 'A.B.C',
	'EMAIL_CHECK_MX'				=> 'Проверить правильность MX-записи домена email-адреса',
	'EMAIL_CHECK_MX_EXPLAIN'		=> 'Если включено, домен email-адреса, указанный при регистрации и изменении профиля, проверяется на правильность  MX-записи (MX record).',
	...
	'FORWARDED_FOR_VALID_EXPLAIN'	=> 'Сессия будет продолжена только в случае, если отправленный заголовок <var>X_FORWARDED_FOR</var> соответствует отправленному в предыдущем запросе. Запрет доступа (бан) будет также проверен по IP-адресам из заголовка <var>X_FORWARDED_FOR</var>.',
	'IP_VALID'						=> 'Проверка IP-адреса сессии',
	'IP_VALID_EXPLAIN'				=> 'Определяет, какая часть IP-адресов пользователей используется для проверки сессии. <samp>Полная</samp> означает проверку всего адреса, <samp>A.B.C</samp> - первых трёх частей (x.x.x), <samp>A.B</samp> - первых двух частей (x.x), <samp>Нет</samp> отключает проверку.',
	'MAX_LOGIN_ATTEMPTS'			=> 'Максимальное количество попыток входа',
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'После указанного количества неудачных попыток входа на конференцию пользоатель должен будет дополнительно подтвердить свой вход (визуальное подтверждение)',
...
$lang = array_merge($lang, array(
	...
	'BOARD_EMAIL_FORM_EXPLAIN'		=> 'Вместо отправки сообщений на email-адреса, пользователи смогут отправлять email-сообщения через конференцию.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ENABLE_EXPLAIN'		=> 'Включение позволяет использовать сообщения и уведомления Jabber',
	...
	'JAB_PORT_EXPLAIN'			=> 'Оставьте пустым, если вам точно не известно, что используется не порт 5222',
