...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_GD_FOREGROUND_NOISE'			=> 'GD CAPTCHA с шумом',
	'CAPTCHA_GD_EXPLAIN'					=> 'Использование библиотеки GD для создания усовершенствованной CAPTCHA.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> 'Использование шума для создания усложнённой CAPTCHA.',
	'CAPTCHA_GD_X_GRID'						=> 'Фон шума CAPTCHA по оси X',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'Использование более низких параметров для создания ещё более сложной CAPTCHA. Введите 0 для отключения создания шума по оси X.',
	'CAPTCHA_GD_Y_GRID'						=> 'Фон шума CAPTCHA по оси Y',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'Использование более низких параметров для создания ещё более сложной CAPTCHA. Введите 0 для отключения создания шума по оси Y.',
