...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Конференция станет недоступной пользователей. Также вы можете ввести короткое сообщение (до 255 символов) для посетителей.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'MAX_CHARS'					=> 'макс.',
	'MIN_CHARS'					=> 'мин.',
	'MIN_TIME_REG'				=> 'Минимальное время на регистрацию',
	'MIN_TIME_REG_EXPLAIN'		=> 'Регистрационная форма не может быть отправлена ранее указанного времени.',
	'MIN_TIME_TERMS'			=> 'Минимальное время для согласия с условиями регистрации',
	'MIN_TIME_TERMS_EXPLAIN'	=> 'Условия регистрации не могут быть приняты ранее указанного времени.',
...
$lang = array_merge($lang, array(
	...
	'FORM_TIME_MIN'					=> 'Минимальное время для отправки формы',
	'FORM_TIME_MIN_EXPLAIN'			=> 'Отправка формы раньше указанного времени будет проигнорирована конференцией. Введите 0 для отключения этой функции.',
...
$lang = array_merge($lang, array(
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Введите имя зарегистрированного пользователя. Проверка имени производиться не будет.',
));
