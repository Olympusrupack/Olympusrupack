...
$lang = array_merge($lang, array(
	...
	'ALLOW_PM_REPORT_EXPLAIN'	=> 'При включении данной опции у пользователей появится опция, позволяющая жаловаться на полученные ими личные сообщения от других пользователей. Такие личные сообщения будут видимы в панели модератора',
...
$lang = array_merge($lang, array(
	...
	'DELETE_TIME'					=> 'Ограничить время удаления',
	'DELETE_TIME_EXPLAIN'			=> 'Ограничить время, в течение которого доступно удаление нового сообщения. Введите 0 для отключения этой возможности.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_MANAGEMENT_EXPLAIN'		=> 'Данный модуль предоставляет различные каналы новостей в формате ATOM, анализируя BBCode в сообщениях, и делая его удобочитаемым во внешних программах чтения каналов новостей.',
	...
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> 'Этот канал отображает последние сообщения из всех тем форумов.',
	'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'Количество элементов на странице для отображения в канале форумов',

	'ACP_FEED_OVERALL_TOPIC'			=> 'Включить общий канал для тем',
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Включение или отключение канала «Все темы».',
	'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'Количество элементов на странице для отображения в канале тем',
	...
	'ACP_FEED_NEWS'						=> 'Каналы новостей',
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Выберите форумы, из которых в канал новостей будет извлекаться первое сообщение. Не выбирайте форумов, чтобы отключить канал новостей. Выберите несколько форумов, удерживая клавишу <samp>Ctrl</samp> и щёлкая мышью по нужным форумам.',

	'ACP_FEED_GENERAL'					=> 'Общие параметры каналов новостей',

	'ACP_FEED_ITEM_STATISTICS'			=> 'Статистика элементов',
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> 'Отображение индивидуальной статистики под элементами канала (автор сообщения, дата и время публикации, количество ответов и просмотров).',
	'ACP_FEED_EXCLUDE_ID'				=> 'Исключить эти форумы',
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'Содержимое следующих форумов не будет включаться в каналы новостей. Не выбирайте форумов, если хотите получать данные со всех форумов. Выберите несколько форумов, удерживая клавишу <samp>Ctrl</samp> и щёлкая мышью по нужным форумам.',
));
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'			=> 'Добавляет к CAPTCHA объекты, расположенные поверх символов.',
