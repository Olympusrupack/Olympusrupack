...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_UNICODE_EXPLAIN'		=> 'Этому поисковму механизму необходимы свойства символов юникода PCRE, доступные только в PHP 4.4, 5.1 и старше, если вы хотите производить поиск по не-латинским символам.',
