...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> 'C помощью этой панели вы можете управлять всеми группами пользователей, удалять их, создавать новые и редактировать существующие. Вы можете назначать лидеров, изменять статус групп, а также задавать названия и описания групп.',
	...
	'GROUP_EDIT_EXPLAIN'			=> 'Здесь можно изменить настройки существующей группы. Вы можете изменить название, описание и тип группы (открытая, закрытая и т.п.). Также можно установить некоторые дополнительные параметры, такие, как цвет, звание и т.п. Текущие настройки пользователей будут заменены в соответствии с произведёнными здесь изменениями. Участники групп могут изменять свои аватары только если вы предоставили им для этого соответствующие права.',
	...
	'GROUP_FOUNDER_MANAGE_EXPLAIN'	=> 'Ограничить управление этой группой только основателями.',
	...
	'GROUP_SETTINGS'				=> 'Настройки пользователей',
	'GROUP_SETTINGS_EXPLAIN'		=> 'Здесь вы можете принудительно изменить текущие настройки пользователей. Учтите, что эти настройки не сохраняются для самой группы. Они предназначены в качестве быстрого метода для изменения настроек всех пользователей этой группы.',
