...
$lang = array_merge($lang, array(
	...
	'BAN_SUCCESSFUL'		=> 'Запрет успешно установлен.',

	'CANNOT_BAN_FOUNDER'			=> 'Вы не можете запретить учётные записи основателей.',
	'CANNOT_BAN_YOURSELF'			=> 'Вы не можете запретить самого себя.',
	...
	'CANNOT_FORCE_REACT_BOT'		=> 'Вы не можете принудительно реактивировать учётные записи ботов. Пожалуйста, реактивируйте бота.',
	'CANNOT_FORCE_REACT_FOUNDER'	=> 'Вы не можете принудительно реактивировать учётные записи основателей.',
	'CANNOT_FORCE_REACT_YOURSELF'	=> 'Вы не можете принудительно реактивировать собственную учётную запись.',
	...
	'CONFIRM_EMAIL_EXPLAIN'			=> 'Вы должны заполнить это поле только при изменении email-адресов пользователей.',

	'DELETE_POSTS'			=> 'Удалить сообщения',
	'DELETE_USER'			=> 'Удалить пользователя',
	'DELETE_USER_EXPLAIN'	=> 'Пожалуйста, учтите, что удаление пользователя окончательно, он не может быть восстановлен',

	'FORCE_REACTIVATION_SUCCESS'	=> 'Реактивация успешно произведена.',
	'FOUNDER'						=> 'Основатель',
	'FOUNDER_EXPLAIN'				=> 'Основатели имеют все права администратора и не могут быть запрещены (забанены), удалены или понижены в статусе',

	'GROUP_APPROVE'					=> 'Одобрить пользователя',
	'GROUP_DEFAULT'					=> 'Задать группу по умолчанию для пользователя',
	...
	'MOVE_POSTS_EXPLAIN'	=> 'Пожалуйста, выберите форум, в который вы хотите переместить все сообщения пользователя.',

	'NO_SPECIAL_RANK'		=> 'Не присвоено специального звания',
	'NOT_MANAGE_FOUNDER'	=> 'Вы пытались управлять учётной записью пользователя со статусом основателя. Только основатели могут управлять учётными записями других основателей.',

	'QUICK_TOOLS'			=> 'Быстрые настройки',

	'REGISTERED'			=> 'Зарегистрирован',
	'REGISTERED_IP'			=> 'Зарегистрирован с IP-адреса',
	'RETAIN_POSTS'			=> 'Задержанные сообщения',
	...
	'USER_ADMIN_BAN_IP_REASON'		=> 'IP-адреса, запрещённые через управление пользователями',
	'USER_ADMIN_BAN_NAME_REASON'	=> 'Имена, запрещённые через управление пользователями',
	...
	'USER_POSTS_DELETED'			=> 'Сообщения пользователя успешно удалены.',
