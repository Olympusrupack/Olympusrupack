...
$lang = array_merge($lang, array(
	...
	'CANNOT_DEACTIVATE_BOT'			=> 'Вы не можете деактивировать учётные записи ботов. Пожалуйста, деактивируйте бота на странице управления ботами.',
	...
	'CANNOT_FORCE_REACT_BOT'		=> 'Вы не можете требовать повторной активации учётной записи бота. Пожалуйста, деактивируйте бота на странице управления ботами.',
