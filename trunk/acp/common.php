...
$lang = array_merge($lang, array(
	...
	'ACP_MAIN'					=> 'Главная страница панели администрирования',
	...
	'ADM_LOGGED_OUT'		=> 'Вы успешно вышли из панели администрирования.',
	...
	'LOGIN_ADMIN'			=> 'Для входа в панель администрирования вы должны быть авторизованы.',
	'LOGIN_ADMIN_CONFIRM'	=> 'Для входа в панель администрирования необходимо повторно ввести своё имя и пароль.',
	'LOGIN_ADMIN_SUCCESS'	=> 'Проверка подлинности прошла успешно. Сейчас вы будете перенаправлены в панель администрирования.',
	...
	'NOTIFY'				=> 'Уведомление',
	'NO_ADMIN'				=> 'У вас нет прав для доступа в панель администрирования.',
	'NO_EMAILS_DEFINED'		=> 'Не найдено правильных адресов электронной почты.',
	'NO_PASSWORD_SUPPLIED'	=> 'Необходимо ввести пароль для получения доступа в панель администрирования.',
	...
	'PIXEL'								=> 'пикс.',
	'PROCEED_TO_ACP'					=> '%sПерейти в панель администрирования%s',
