...
$lang = array_merge($lang, array(
	...
	'SETTING_TOO_LOW'		=> 'Введённое значение параметра «%s» слишком мало. Минимальное допустимое значение - %d.',
	'SETTING_TOO_BIG'		=> 'Введённое значение параметра «%s» слишком велико. Максимальное допустимое значение - %d.',   
	'SETTING_TOO_LONG'		=> 'Введённое значение параметра «%s» слишком длинное. Максимальная допустимая длина - %d.',
	'SETTING_TOO_SHORT'		=> 'Введённое значение параметра «%s» недостаточно длинное. Минимальная допустимая длина - %d.',
