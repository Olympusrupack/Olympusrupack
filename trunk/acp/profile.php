...
$lang = array_merge($lang, array(
	...
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> 'Значение поля будет показано везде, где разрешено, в настройках нагрузки на сервер. Если установлено значение «Нет», данное поле будет скрыто при просмотре тем, профилей, списка пользователей.',
