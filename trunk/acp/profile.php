...
$lang = array_merge($lang, array(
	...
	'BOOL_TYPE_EXPLAIN'		=> 'Вид вариантов выбора: флажки или переключатели',
	...
	'DISPLAY_AT_REGISTER_EXPLAIN'	=> 'Если включено, поле можно заполнить при регистрации и изменить в личном разделе.',
	'DISPLAY_PROFILE_FIELD'			=> 'Отображать поле',
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> 'Значение поля будет показано при просмотре темы, профиля, списка пользователей, если это разрешено в разделе ограничения нагрузки. По умолчанию поле отображается только в профиле пользователя.',
	...
	'HIDE_PROFILE_FIELD'			=> 'Скрыть поле',
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Только администраторы и модераторы могут видеть/править это поле профиля. Если включено, то поле будет отображаться лишь в профилях пользователей.',
	...
	'PREVIEW_PROFILE_FIELD'		=> 'Предпросмотр поля профиля',
	...
	'STEP_2_EXPLAIN_EDIT'			=> 'Здесь вы можете изменить общие настройки будущего поля. Затем можно будет посмотреть, как будет выглядеть для пользователя измененное поле. Поиграйте с настройками, пока не будете удовлетворены тем, как работает поле.<br /><strong>Обратите внимание, что изменения полей профиля не коснутся уже существующих полей, заполненных пользователями.</strong>',
	...
	'STEP_3_EXPLAIN_EDIT'			=> 'Так как на конференции установлено более одного языка, вы можете изменить или добавить данные для остальных языков. Название поля, подсказка и начальное значение будут отображаться на языке по умолчаниюУ.',
