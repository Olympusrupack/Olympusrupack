...
$lang = array_merge($lang, array(
	...
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Здесь вы можете добавить, удалить, изменить или отключить группы расширений. Дальнейшие настройки включают назначение им специальных категорий, изменение механизма скачивания и определение значка загрузки, который будет отображаться перед вложением, принадлежащим к группе.',
	'ACP_MANAGE_EXTENSIONS_EXPLAIN'		=> 'Здесь вы можете управлять разрешёнными расширениями. Для активации расширений, пожалуйста, обратитесь к панели управления группами расширений. Мы настоятельно рекомендуем не разрешать расширения скриптов (такие, как <code>php</code>, <code>php3</code>, <code>php4</code>, <code>phtml</code>, <code>pl</code>, <code>cgi</code>, <code>py</code>, <code>rb</code>, <code>asp</code>, <code>aspx</code>, и так далее…)',
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Здесь вы можете видеть файлы, находящиеся в папке для загрузки вложений, но не прикреплённые к сообщениям. Это происходит по большей части тогда, когда пользователи прикрепляют файлы, но не отправляют сообщение целиком. Вы можете удалить такие файлы или прикрепить их к уже существующим сообщениям. Прикрепление к сообщению потребует его правильного номера (ID), который вы должны определить самостоятельно. Эта возможность главным образом подходит тем, кто желает загружать файлы (особенно больших размеров) с помощью сторонних программ и привреплять их к уже существующим сообщениям.',
	...
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Максимальный размер дискового пространства, доступный каждому пользователю для вложений в личном сообщении, 0 означает неограниченный размер.',
	'ATTACH_ORPHAN_URL'					=> 'Одиночные вложения',
	...
	'CAT_QUICKTIME_FILES'		=> 'Медиа файлы Quicktime',
	'CAT_RM_FILES'				=> 'Медиа файлы RealMedia',
	'CAT_WM_FILES'				=> 'Медиа файлы Windows Media',
	...
	'IMAGE_LINK_SIZE_EXPLAIN'	=> 'Показ изображений в виде ссылки в тексте, если его размер больше указанного. Для отключения этой возможности установите значения 0px на 0px.',
	'IMAGICK_PATH'				=> 'Путь к Imagemagick',
	'IMAGICK_PATH_EXPLAIN'		=> 'Полный путь к приложению imagemagick, например <samp>/usr/bin/</samp>',

	'MAX_ATTACHMENTS'				=> 'Максимальное число вложений в сообщении',
	'MAX_ATTACHMENTS_PM'			=> 'Максимальное число вложений в личном сообщении',
	'MAX_EXTGROUP_FILESIZE'			=> 'Максимальный размер файла',
	'MAX_IMAGE_SIZE'				=> 'Максимальные размеры изображения',
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Максимальные размеры вложенных изображений. Установите обе значения 0px на 0px для отключения проверки размеров.',
	'MAX_THUMB_WIDTH'				=> 'Максимальная ширина миниатюры в пикселах',
	'MAX_THUMB_WIDTH_EXPLAIN'		=> 'Ширина созданной миниатюры будет не больше заданной здесь',
	...
	'NO_UPLOAD_DIR'				=> 'Указанная папка для загрузки не существует.',
	'NO_WRITE_UPLOAD'			=> 'В указанную папка для загрузки невозможно осуществить запись. Пожалуйста, измените права доступа, разрешив вебсерверу осуществлять в неё запись.',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Изменить порядок по умолчанию списка разрешённых/запрещённых, если разрешены безопасное скачивание, на соответствующий <strong>белому списку</strong> (Разрешить) или <strong>чёрному списку</strong> (Запретить)',
	...
	'SECURE_DOWNLOAD_NOTICE'		=> 'Безопасные скачивания не включены. Настройки ниже будут применены после включания безопасных скачиваний.',
	...
	'UPLOADING_FILE_TO'				=> 'Загрузка файла «%1$s» в сообщение номер %2$d…',
	...
	'UPLOAD_NOT_DIR'				=> 'Указанный путь для загрузки не является папкой.',
));
