...
$lang = array_merge($lang, array(
	...
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Здесь вы можете добавить, удалить, изменить или отключить группы расширений. Дополнительные настройки включают назначение им специальных категорий, изменение механизма скачивания и определение значка загрузки, который будет отображаться перед вложением, принадлежащим к группе.',
	...
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Здесь вы можете видеть файлы, находящиеся в папке для загрузки вложений, но не прикреплённые к сообщениям. Обычно это происходит, когда пользователи прикрепляют файл, но не отправляют сообщение. Вы можете удалить такие файлы или прикрепить их к уже существующим сообщениям. Прикрепление к сообщению потребует его правильного номера (ID), который вы должны определить самостоятельно. Эта возможность главным образом подходит тем, кто желает загружать файлы (особенно больших размеров) с помощью сторонних программ и привреплять их к уже существующим сообщениям.',
	...
	'NO_WRITE_UPLOAD'			=> 'В указанную папка для загрузки невозможно осуществить запись. Пожалуйста, измените права доступа, разрешив веб-серверу осуществлять в неё запись.',
