...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Максимальный размер всех вложений, которые пользователь может хранить в папке личных сообщений. Значение 0 соответствует неограниченному размеру.',
	...
	'IMAGE_LINK_SIZE_EXPLAIN'	=> 'Если рисунок больше указанных размеров, то вместо него будет отображена ссылка для загрузки этого рисунка. Введите размеры 0x0 для отключения этой возможности.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Максимальные размеры влагаемых рисунков. Введите 0x0 для отключения проверки размеров.',
	...
	'NO_WRITE_UPLOAD'			=> 'Указанная вами папка для загрузки недоступна для записи. Измените права доступа для этой папки, разрешив серверу запись в неё.',
	...
	'UPLOADING_FILE_TO'				=> 'Загрузка файла «%1$s» в сообщение с номером %2$d…',
