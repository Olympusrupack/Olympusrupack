...
$lang = array_merge($lang, array(
	'AUTO_PRUNE_DAYS'			=> 'Автоочистка по последним сообщениям',
	...
	'AUTO_PRUNE_FREQ_EXPLAIN'	=> 'Время в днях, которое должно пройти между двумя очистками.',
	...
	'COPY_PERMISSIONS_ADD_EXPLAIN'	=> 'После создания форуму будут присвоены те же права доступа, что и у выбранного здесь. Если форум не выбран, вновь созданный форум не будет отображаться на конференции до установки прав доступа.',
	...
	'ENABLE_INDEXING_EXPLAIN'		=> 'Если включено, сообщения в этом форуме будут проиндексированы для поиска.',
	...
	'FORUM_RULES_EXPLAIN'				=> 'Правила форума отобржаются на кадждой странице в пределах данного форума.',
	'FORUM_RULES_LINK'					=> 'Ссылка на правила форума',
	'FORUM_RULES_LINK_EXPLAIN'			=> 'Здесь вы можете задать ссылку на (URL) страницу/сообщение с правилами форума. При этом текст правил форума будет заменён.',
	...
	'PRUNE_OLD_POLLS_EXPLAIN'	=> 'Удаляет темы с опросами, в которые отсутствуют голоса, в зависимости от возраста (дней).',
	
	'REDIRECT_ACL'	=> 'Теперь вы можете %sустановит права доступа%s для этого форума.',
