...
*
* @package language
* @version $Id: help_faq.php,v 1.37 2007/05/19 17:09:45 davidmj Exp $
...
$help = array(
	...
	array(
		0 => 'Я забыл пароль!',
		1 => 'Не паникуйте! Хотя пароль нельзя восстановить, можно легко получить новый. Перейдите на страницу входа в систему и щелкните на ссылку <em>Забыли пароль?</em>. Следуйте инструкциям, и скоро вы снова сможете войти на конференцию.'
	),
	array(
		0 => 'Я только что зарегистрировался, но не могу войти!',
		1 => 'Сначала проверьте свои имя пользователя и пароль. Если они верны, то возможны два варианта. Если включена поддержка COPPA и при регистрации вы указали, что вам менее 13 лет, следуйте полученным инструкциям. Некоторые конференции требуют активации всех новых учётных записей самими пользователями или администратором до входа в систему. Эта информация отображается в процессе регистрации. Если вам был прислано email-сообщение, следуйте полученным инструкциям. Если email-сообщение не получено, то возможно, что вы указали неправильный адрес email, либо он заблокирован спам-фильтром. Если вы уверены, что ввели правильный адрес email, попробуйте связаться с администратором.'
	),
	array(
	...
	array(
		...
		1 => 'Она удаляет все созданные cookies, которые позволяют вам оставаться авторизованными на этой конференции, а также выполняет другие функции, такие, как отслеживание прочитанных сообщений, если эта возможность включена администратором. Если вы испытываете проблемы со входом или выходом на конференции, возможно, удаление cookies поможет.',
	),
 	array(
		0 => '--',
	...
	array(
		...
		1 => 'Please note that changing the timezone, like most settings, can only be done by registered users. If you are not registered, this is a good time to do so. Хотя в редких случаях часы сервера бывают настроены неверно, обычно время правильное. Возможно, отображается время, относящееся к другому часовому поясу, а не к тому, в котором находитесь вы. В этом случае измените в личных настройках часовой пояс на тот, в котором вы находитесь: Москва, Киев и т.д. Учтите, что изменять часовой пояс, как и большинство настроек, могут только зарегистрированные пользователи.'
	),
	array(
	...
	array(
		...
		1 => 'Под именем пользователя могут быть два изображения. В зависимости от используемого стиля, первое может относиться к вашему званию, обычно это звёздочки, блоки или точки, указывающие на то, сколько сообщений вы оставили или на ваш статус на конференции. Второе, обычно более крупное изображение, известно как «аватара» и обычно уникальна для каждого пользователя. От администратора зависит, включена ли поддержка аватар, и от него же зависит, каким образом они могут быть доступны. Если вы не можете использовать аватары, свяжитесь с администратором конференции для выяснения причин.'
	),
	array(
		0 => 'Как я могу изменить свое звание?',
		1 => 'Звания, отображаемые под вашим именем, отражают количество созданных вами сообщений, или идентифицируют определенных пользователей: например, модераторов и администраторов. Обычно вы не можете напрямую изменять наименования званий на конференции, так как они установлены её администратором. Пожалуйста, не засоряйте конференцию ненужными сообщениями только для того, чтобы повысить своё звание. Большинство конференций не потерпят этого, и модератор или администратор понизят значение вашего счётчика сообщений.'
	),
	array(
		0 => 'Когда я щёлкаю по ссылке «email» от меня требуют войти на конференцию?',
		1 => 'Только зарегистрированные пользователи могут отправлять email-сообщения другим пользователям через встроенную в конференцию форму, и только если администратор включил такую возможность. Это сделано для того, чтобы предотвратить злонамеренного использования почтовой системы анонимными пользователями.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Если это разрешено администратором конференции, вы должны увидеть кнопку, предназначенную для отправки жалобы на сообщение, расположенную в сообщении, на которое вы хотите пожаловаться. Щёлкнув по этой кнопке, вы пройдёте через ряд шагов, необходимых для оправки жалобы на сообщение.'
	),
	array(
	...
	array(
		...
		1 => 'Для отказа от подписки перейдите в ваш личный раздел и щёлкните по ссылке «Подписки».'
	),
	array(
		0 => '--',
		1 => 'Вложения'
	...
	array(
		...
		1 => 'Вы можете связаться с любым из администраторов, перечисленных в списке на странице «Наша команда». Если вы не получили ответа, свяжитесь с владельцем домена (сделайте <a href="http://www.google.com/search?q=whois">whois lookup</a>) или, если конференция находится на бесплатном домене (например chat.ru, Yahoo!, free.fr, f2s.com, etc.), с руководством или техподдержкой данного домена. Пожалуйста, учтите, что phpBB Group <strong>не имеет никакого контроля над данной конференцией</strong>, и не может нести никакой ответственности за то, кем и как данная конференция используется. Не обращайтесь к phpBB Group по юридическим вопросам (о приостановке работы конференции, ответственности за неё и т.д.), которые <strong>не относятся напрямую</strong> к сайту phpBB.com, или которые частично относятся к программному обеспечению phpBB Group. Если же вы все-таки пошлёте email в адрес phpBB Group об использовании данной конференции <strong>третьей стороной</strong>, то не ждите подробного письма, или вы можете вообще не получить ответа.'
	)
);
