...
$lang = array_merge($lang, array(
	...
	'DL_CONFIG_EXPLAIN'			=> 'Вы можете целиком скачать файл config.php к себе на компьютер. Затем вам будет нужно вручную закачать этот файл в корневую директорию phpBB 3.0, заменив исходный config.php. Помните, что файл должен быть закачан на сервер в формате ASCII (если вы не знаете как этого добиться, обратитесь к документации вашего FTP-клиента). После того, как закачаете config.php, щелкните «Готово» для перехода к следующему шагу.',
	'DL_DOWNLOAD'				=> 'Скачать',
	'DONE'						=> 'Готово',

	'ENABLE_KEYS'				=> 'Активация ключей. Эта операция может занять некоторое время',
	...
	'FORUM_PATH_EXPLAIN'		=> '<strong>Относительный</strong> путь к старой конференции от <strong>корневой директории установленного phpBB</strong>',
	'FOUND'						=> 'Найден',
	...
	'FTP_PATH'					=> 'Путь относительно FTP',
	'FTP_PATH_EXPLAIN'			=> 'Путь от корневой директории FTP до корневой директории phpBB, например, htdocs/phpBB3/',
	'FTP_UPLOAD'				=> 'Закачать',

	'GPL'						=> 'Общедоступная лицензия',
