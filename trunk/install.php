...
$lang = array_merge($lang, array(
	...
	'INSTALL_INTRO_BODY'		=> 'Здесь можно установить phpBB3 на ваш сервер.</p><p>Для этого потребуются информация о базе данных. Если вы не знаете настроек вашей базы данных, свяжитесь с вашим хостером и узнайте их у него. Вы не сможете продолжить установку без этих данных. Вам нужно знать:</p>
	...
	'OVERVIEW_BODY'					=> 'Добро пожаловать в phpBB3!<br /><br />phpBB™ является наиболее распространённым решением с открытым кодом для организации конференций в интернете. phpBB3 стал очередным этапом семилетней разработки программного продукта. Как и его предшественники, phpBB3 является функциональным, имеет дружественный интерфейс и полностью поддерживается phpBB Team. В phpBB3 существенно улучшены качества, сделавшие популярным phpBB2, добавлены наиболее необходимые функции, которые отсутствовали в предыдущих версиях. Надеемся, что это превзойдёт ваши ожидания.<br /><br />Эта система проведёт вас через процессы установки phpBB3, обновления предыдущих релизов до последней версии phpBB3, а также конвертирования в phpBB3 другого программного обеспечения для конференций (включая phpBB2). Для получения дополнительной информации мы предлагаем вам ознакомиться с <a href="../docs/INSTALL.html">руководством по установке</a>.<br /><br />Чтобы ознакомиться с лицензионными условиями phpBB3 или узнать о поддержке, выберите соответствующий пункт в боковом меню. Для продолжения выберите нужную закладку выше.',
