...
$lang = array_merge($lang, array(
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>Единая система конвертирования phpBB поддерживает конвертирование из phpBB 2.0.x и других типов конференций в phpBB3. Если у вас есть конференция, которую вы желаете сконвертировать, <a href="%2$s">прейдите в систему конвертирования</a>.</p>
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Перейти на <a href="ttp://www.phpbb.com/downloads/" title="ttp://www.phpbb.com/downloads/">страницу файлов phpBB.com</a> и скачать подходящий архив обновлений ("phpBB Update Package").<br /><br /></li>
