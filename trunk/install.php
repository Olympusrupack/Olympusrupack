...
$lang = array_merge($lang, array(
	...
	'INSTALL_INTRO_NEXT'		=> 'Что бы начать установку, нажмите кнопку ниже.',
	'INSTALL_LOGIN'				=> 'Войти',
	...
	'INST_ERR_FATAL'			=> 'Фатальная ошибка при установке',
	'INST_ERR_FATAL_DB'			=> 'Произошла фатальная ошибка при работе с базой данных, установка прервана. This may be because the specified user does not have appropriate rights to <code>CREATE TABLES</code> or <code>INSERT</code> data, etc. Further information may be given below. Please contact your hosting provider in the first instance or the support forums of phpBB for further assistance.',
