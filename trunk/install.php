...
// TODO: Write some text on obtaining support
	'SUPPORT_BODY'				=> 'В период бета-тестирования <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">на форуме поддержки бета-версий phpBB 3.0</a> (на английском) будет оказываться ограниченная поддержка. Мы будем отвечать на общие вопросы, связанные с установкой, проблемами настройки и оказывать поддержку в решении проблем общего характера, в основном связанных с ошибками в phpBB. Поддержка модов и стилей, а также пользователей, использующих конференцию не в целях бета-тестирования, оказываться не будет.</p><p>За дополнительной помощью обращайтесь к <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Краткому руководству пользователя</a> (на английском).</p><p>Чтобы быть в курсе последних новостей и следить за релизами, <a href="http://www.phpbb.com/support/">подпишитесь на нашу рассылку</a>.',
