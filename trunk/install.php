...
$lang = array_merge($lang, array(
	...
	'BOARD_NOT_INSTALLED'			=> 'Не найдено предыдущей установленного phpBB3',
	...
	'CONTINUE_CONVERT_BODY'		=> 'Обнаружена предыдущая попытка конвертирования. Вы можете выбрать между новым конвертированием или продолжить предыдущее',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Вы успешно конвертировали вашу конференцию в формат phpBB 3.0. Вы можете войти и <a href="../">получить доступ к конференции</a>. Помните, что вспомогательную информацию по использованию phpBB можно получить в Интернете, изучив <a href="http://www.phpbb.com/support/documentation/3.0/">Руководство пользователя</a> и на <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">Форуме поддержки</a>',
