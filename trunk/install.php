...
// TODO: Write some explanatory introduction text
	...
	'REFRESH_PAGE_EXPLAIN'		=> '«Да» означает, что конвертор будет перезагружать страницу, чтобы продолжить конвертацию после завершения очередного этапа. Если это ваша первая конвертация с целью тестирования и проверки на ошибки, мы советуем установить значение этого параметра в «Нет».',
//	'REQUIRED'					=> 'Required',
