...
$lang = array_merge($lang, array(
	...
	'POST_EDITED_MOD'			=> 'Сообщение было успешно отредактировано, но потребует одобрения модератора до того, как будет отображено на конференции. Вы будете уведомлены об одобрении вашего сообщения.',
	'POST_GLOBAL'				=> 'Важная',
	...
	'POST_STORED_MOD'			=> 'Сообщение было успешно отправлено, но потребует одобрения модератора до того, как будет отображено на конференции. Вы будете уведомлены об одобрении вашего сообщения',
