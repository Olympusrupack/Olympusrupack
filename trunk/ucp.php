...
*
* @package language
* @version $Id: ucp.php,v 1.95 2007/01/28 13:09:40 acydburn Exp $
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Учётная запись была создана. На этом форуме требуется активация новой учётной записи одним из администраторов. Им был отправлен email, и, как только они активируют вашу учётную запись, вы получите уведомление.',
	...
	'PERMISSIONS_TRANSFERRED'	=> 'Имитация прав доступа, установленных для <strong>%s</strong>, успешно проведена. Сейчас вы  можете просматривать форум с ограничениями, установленными для пользователя.<br />Пожалуйста, помните, что права администратора отключены. Вы можете прервать имитацию в любое время.',
