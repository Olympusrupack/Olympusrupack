...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Учётная запись была создана. На этом форуме требуется активация учётной записи, ключ для активации был выслан на введённый вами адрес. Проверьте свою электронную почту для получения более подробной информации.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Учётная запись была создана. На этом форуме требуется активация новой учётной записи группой администраторов. Им было отправлено сообщение email. Вы будете уведомлены, когда ваша учётная запись будет активирована.',
	...
	'EXPORT_FOLDER'				=> 'Экспортировать этот вид',
	...
	'FOES_EXPLAIN'				=> 'Недруги - это пользователи, которые будут игнорироваться по умолчанию. Сообщения этих пользователей будут скрыты. Личные сообщения от недругов запрещены. Учтите, что вы не можете игнорировать модераторов или администраторов.',
    ...
    'LOGOUT_FAILED'             => 'Вы не вышли из системы, так как запрос не соответствовал параметрам вашей сессии. Свяжитесь с администратором конференции, если проблема повторится.',
	...
	'PROFILE_INFO_NOTICE'		=> 'Пожалуйста, помните, что эта информация может быть доступна другим пользователям. Будьте осторожны при выборе указываемых персональных данных. Любые поля, обозначенные * должны быть заполнены.',
	...
	'UCP_PM_OPTIONS'			=> 'Правила, папки &amp; настройки',
	...
	'USERNAME_ASCII_EXPLAIN'		=> 'Имя пользователя не должно быть меньше %1$d или больше %2$d символов и должно содержать только символы ASCII, без специальных символов.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Имя пользователя не должно быть меньше %1$d или больше %2$d символов и должно содержать только буквы или цифры.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Имя пользователя не должно быть меньше %1$d или больше %2$d символов и должно содержать только буквы, цифры, пробел или символы -+_[]',
