...
$lang = array_merge($lang, array(
	...
	'PLUPLOAD_FILENAME'			=> 'Название файла',
	'PLUPLOAD_FILES_QUEUED'		=> '%d файлы в очереди',
	'PLUPLOAD_GENERIC_ERROR'	=> 'Общая ошибка.',
	'PLUPLOAD_HTTP_ERROR'		=> 'HTTP ошибка.',
	'PLUPLOAD_INIT_ERROR'		=> 'Init ошибка.',
	'PLUPLOAD_IO_ERROR'			=> 'IO ошибка.',
	'PLUPLOAD_NOT_APPLICABLE'	=> 'N/A',
	'PLUPLOAD_SECURITY_ERROR'	=> 'Ошибка безопасности.',
	'PLUPLOAD_SELECT_FILES'		=> 'Выделить файлы',
	'PLUPLOAD_SIZE'				=> 'Размер',
	'PLUPLOAD_SIZE_ERROR'		=> 'Ошибка размера файла.',
	'PLUPLOAD_STATUS'			=> 'Статус',
	'PLUPLOAD_START_UPLOAD'		=> 'Загрузить',
	'PLUPLOAD_START_CURRENT_UPLOAD'	=> 'Начать загружать файлы в очереди',
	...
	'PLUPLOAD_UPLOADED'			=> 'Загружено %d/%d файлов',
));
