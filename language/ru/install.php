...
$lang = array_merge($lang, array(
	...
	'INST_ERR_DB_INVALID_PREFIX'=> 'Указан неправильный префикс. Он должен начинаться с алфавитно-цифрового символа и может содержать только алфавитно-цифровые символы, числа и знаки подчёркивания.',
	...
	'TABLE_PREFIX_EXPLAIN'		=> 'Префикс должен начинаться с алфавитно-цифрового символа и может содержать только алфавитно-цифровые символы, числа и знаки подчёркивания.',
