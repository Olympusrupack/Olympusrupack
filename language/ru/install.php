...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Вы успешно сконвертировали вашу конференцию в формат phpBB 3.1. Вы можете <a href="../">войти на конференцию</a>. Убедитесь, что все настройки успешно перенесены, прежде чем запустите конференцию, удалив папку install. Помните, что вспомогательную информацию по использованию phpBB можно получить в интернете, изучив <a href="http://www.phpbb.com/support/documentation/3.0/">документацию</a>, а также на <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">форуме поддержки phpBB Group</a> и форумах официальной русской поддержки <a href="http://phpbbguru.net">phpBB Guru</a>.',
	...
	'SELECT_FORUM_GA'			=> 'В phpBB 3.1 важные темы привязаны к форумам. Выберите форум для данногой важной темы (темуа можеть быть перенесена в другой форум позже):',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Все файлы соответствуют самой последней версии phpBB. Теперь <a href="%1$s">войдите на конференцию</a> и проверьте, что всё работает нормально. Не забудьте удалить, переименовать или переместить папку «install»! Пожалуйста, отправьте нам обновлённую информацию о вашем сервере и конфигурации конференции с помощью страницы <a href="%2$s">Статистические данные</a> в администраторском разделе.',
