...
$lang = array_merge($lang, [
	...
	'CONFIRM_QUESTION_MISSING'	=> 'Не удалось получить вопросы. Свяжитесь с администратором конференции.',
	...
	'QUESTIONS'					=> 'Вопросы',
	'QUESTIONS_EXPLAIN'			=> 'При отправке форм, для которых включено текстовое подтверждение, пользователю будет предложен один из указанных здесь вопросов. Для использования данного модуля должен быть установлен по крайней мере один вопрос на языке по умолчанию. Эти вопросы должны быть просты для вашей потенциальной аудитории, но в то же время сложны для бота, способного найти ответ через поиск в Google™. Достаточно только одного надёжного вопроса, защищающего от ботов. Если, несмотря на это, спам-боты регистрируются, измените вопрос. Включите строгую проверку, если ответ на ваш вопрос зависит от знаков препинания, пробелов или регистра символов.',
