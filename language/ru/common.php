...
$lang = array_merge($lang, array(
	...
	'NOTIFICATION_BOOKMARK_TRIMMED'		=> array(
		1	=>	'%1$s и ещё %3$d пользователь ответили в теме «%2$s», находящейся у Вас в закладках.',
		2	=>	'%1$s и ещё %3$d пользователя ответили в теме «%2$s», находящейся у Вас в закладках.',
		3	=>	'%1$s и ещё %3$d пользователей ответили в теме «%2$s», находящейся у Вас в закладках.',
	),
	...
	'NOTIFICATION_POST_TRIMMED'			=> array(
		1	=>	'%1$s и ещё %3$d пользователь ответили в теме «%2$s»',
		2	=>	'%1$s и ещё %3$d пользователя ответили в теме «%2$s»',
		3	=>	'%1$s и ещё %3$d пользователей ответили в теме «%2$s»',
	),
	...
	'NOTIFICATION_QUOTE_TRIMMED'		=> array(
		1	=>	'%1$s и ещё %3$d пользователь процитировали Вас в теме «%2$s»',
		2	=>	'%1$s и ещё %3$d пользователя процитировали Вас в теме «%2$s»',
		3	=>	'%1$s и ещё %3$d пользователей процитировали Вас в теме «%2$s»',
	),
