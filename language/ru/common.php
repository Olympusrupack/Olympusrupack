...
$lang = array_merge($lang, array(
	...
	'NOTIFICATION_REPORT_PM'			=> '<strong>Жалоба на личное сообщение</strong> от %1$s:',
	'NOTIFICATION_REPORT_POST'			=> '<strong>Жалоба на сообщение</strong> от %1$s:',
	'NOTIFICATION_REPORT_CLOSED'		=> '<strong>Жалоба закрыта</strong> пользователем %1$s по причине:',
	'NOTIFICATION_TOPIC'				=> '<strong>Новая тема</strong> от %1$s:',
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>Тема одобрена</strong>:',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> '<strong>Тема отклонена</strong>:',
	'NOTIFICATION_TOPIC_IN_QUEUE'		=> '<strong>Ожидает одобрения</strong> тема от %1$s:',
