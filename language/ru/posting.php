...
$lang = array_merge($lang, array(
	...
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'Вы уверены, что хотите <strong>навсегда</strong> удалить это сообщение?',
	'DELETE_POST_PERMANENTLY'	=> 'Удаленное навсегда сообщение восстановить невозможно',
	'DELETE_POSTS_CONFIRM'		=> 'Вы уверены, что хотите удалить эти сообщения?',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> 'Вы уверены, что хотите <strong>навсегда</strong> удалить эти сообщения?',
	'DELETE_REASON'				=> 'Причина мягкого удаления',
	...
	'DELETE_TOPIC_PERMANENTLY'	=> 'Удаленную навсегда тему восстановить невозможно',
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'	=> 'Вы уверены, что хотите <strong>навсегда</strong> удалить эту тему?',
	'DELETE_TOPICS_CONFIRM'		=> 'Вы уверены, что хотите удалить эти темы?',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> 'Вы уверены, что хотите <strong>навсегда</strong> удалить эти темы?',
	...
	'MESSAGE_BODY_EXPLAIN'		=> array(
		...
		1	=> 'Введите текст вашего сообщения. Длина сообщения в символах не более: <strong>%d</strong>.',
		2	=> 'Введите текст вашего сообщения. Длина сообщения в символах не более: <strong>%d</strong>.',
	),
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> 'Разместите каждый вариант ответа в новой строке. Максимальное количество вариантов: <strong>%d</strong>.',
		2	=> 'Разместите каждый вариант ответа в новой строке. Максимальное количество вариантов: <strong>%d</strong>.',
	),
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> array(
		1	=> 'Разместите каждый вариант ответа в новой строке. Максимальное количество вариантов: <strong>%d</strong>. Если вы удалите или добавите новый вариант ответа, результаты голосования обнулятся.',
		2	=> 'Разместите каждый вариант ответа в новой строке. Максимальное количество вариантов: <strong>%d</strong>. Если вы удалите или добавите новый вариант ответа, результаты голосования обнулятся.',
	),
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Введите 0, чтобы тема всегда была объявлением или прилепленной. Обратите внимание на то, что это число является относительным к дате публикации сообщения.',
	'STYLES_TIP'				=> 'Совет: можно быстро применить стили к выделенному тексту.',

	'TOO_FEW_CHARS'				=> 'Ваше сообщение слишком короткое.',
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1	=> 'Ваше сообщение содержит символов: %1$d . Минимальное количество символов, необходимое для публикации сообщения — %2$d.',
		2	=> 'Ваше сообщение содержит символов: %1$d . Минимальное количество символов, необходимое для публикации сообщения — %2$d.',
	),
	...
	'TOO_MANY_CHARS_POST'		=> array(
		2	=> 'Ваше сообщение содержит слишком много символов: %1$d. Максимальное разрешённое количество: %2$d.',
	),
	'TOO_MANY_CHARS_SIG'		=> array(
		2	=> 'Ваша подпись содержит слишком много символов: %1$d. Максимальное разрешённое количество: %2$d.',
	),
	...
	'WRONG_SIZE'				=> 'Размеры изображения должны быть не менее %1$d×%2$d и не более %3$d×%4$d. Размер отправленного изображения — %5$d×%6$d.',
));
