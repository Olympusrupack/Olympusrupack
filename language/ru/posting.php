...
$lang = array_merge($lang, array(
	...
	'REMOTE_UPLOAD_TIMEOUT'		=> 'Указанный файл не может быть загружен аз-за превышения времени ожидания запроса.',
	'SAVE'						=> 'Сохранить',
	...
	'WRONG_FILESIZE'			=> 'Слишком большой размер вложения. <br/>Максимальный разрешённый размер: %1$d %2$s.',
