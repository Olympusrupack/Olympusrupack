...
$help = array(
	...
	array(
		0 => 'Чем закладки отличаются от подписок?',
	...
	array(
		...
		1 => 'Можно подписаться на определённую тему, щёлкнув по соответствующей ссылке в меню «Управление темой», которое находится в верхней и нижней части на странице просмотра тем. <br />Отметив галочкой пункт «Сообщать мне о получении ответа» при отправке сообщения, вы также подпишетесь на соответствующую тему.'
	),
	array(
