...
$help = array(
	...
	array(
		...
		1 => 'Это программное обеспечение (в его исходной форме) создано и распространяется <a href="https://www.phpbb.com/">phpBB Limited</a>. Оно доступно на условиях GNU General Public Licence и может свободно распространяться. Для получения более подробных сведений перейдите по приведённой ссылке.'
	),
	array(
