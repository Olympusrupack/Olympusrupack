...
$help = array(
	...
	array(
		...
		1 => 'Это программное обеспечение было создано и лицензировано phpBB Group. Если вы считаете, что какая-то функция должна быть добавлена, или хотите сообщить об ошибке, посетите сайт phpBB <a href="http://area51.phpbb.com/">Area51</a> и узнайте, как это сделать.'
	),
	array(
