...
$lang = array_merge($lang, array(
	...
	'DISABLE_EXPLAIN'		=> 'При выключении расширения сохраняются его файлы и настройки, а добавляемые им функции отключаются.',
	...
	'DISABLE_SUCCESS'		=> 'Расширение успешно выключено',
	'PURGE_SUCCESS'			=> 'Расширение успешно очищено',

	'ENABLE_FAIL'			=> 'Расширение не может быть включено',
	'DISABLE_FAIL'			=> 'Расширение не может быть выключено',
