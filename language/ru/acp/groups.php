...
$lang = array_merge($lang, [
	...
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'Вы действительно хотите добавить пользователя %2$s в группу?',
		2	=> 'Вы действительно хотите добавить пользователей %2$s в группу?',
		3	=> 'Вы действительно хотите добавить пользователей %2$s в группу?',
	),
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Эта настройка переопределяет ограничения на количество сообщений в папке для пользователей. Будет использовано значение, установленное на уровне группы.<br />Установите 0, чтобы использовать общее значение для конференции по умолчанию.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'Максимальное разрешённое количество получателей личного сообщения. Будет использовано значение, установленное на уровне группы.<br />Установите 0, чтобы использовать общее значение для конференции по умолчанию.',
	...
	'GROUP_USERS_INVALID'			=> 'Пользователи не были добавлены в группу, так как следующие учётные записи не существуют: %s',
