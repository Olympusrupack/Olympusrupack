...
$lang = array_merge($lang, array(
	...
	'ALPHA_DOTS'			=> 'Только буквенно-цифровые и точки',
	...
	'ALPHA_PUNCTUATION'		=> 'Только буквенно-цифровые, запятые, точки, подчёркивание и тире, начинающиеся с буквы',
	...
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'Поле контакта отображается в разделе контактов профиля пользователя, а также в минипрофилях при просмотре тем и личных сообщений.',
