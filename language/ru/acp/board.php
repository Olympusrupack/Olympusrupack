...
$lang = array_merge($lang, [
	...
	'SITE_HOME_URL_EXPLAIN'			=> 'Если задано, данная ссылка будет добавлена в начало меню навигации конференции, а также к логотипу конференции. Ссылка должна быть абсолютной, например <samp>httpы://www.phpbbguru.net</samp>.',
...
$lang = array_merge($lang, [
	...
	'TEST_EMAIL_SENT'				=> 'Тестовое email-сообщение отправлено.<br>Если вы не получили тестовое email-сообщение, проверьте настройки почты.<br><br>Для получения помощи, обратитесь на форумы <a href="httpы://www.phpbbguru.net/community/">официальной русской поддержки phpBB</a>.',
