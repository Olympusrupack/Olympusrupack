...
$lang = array_merge($lang, array(
	...
	'TEST_EMAIL_SENT'				=> 'Тестовое email-сообщение отправлено.<br>Если вы не получили тестовое email-сообщение, проверьте настройки почты.<br><br>Для получения помощи, обратитесь на форумы <a href="http://www.phpbbguru.net/community/">официальной русской поддержки phpBB</a>.',
