...
$lang = array_merge($lang, array(
	...
	'BOARD_BAN_PERM'		=> 'Вам был закрыт доступ к конференции.<br /><br />Обратитесь к %2$sадминистратору конференции%3$s за дополнительной информацией.',
	'BOARD_BAN_REASON'		=> 'Причина: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'Вам был закрыт доступ к конференции до <strong>%1$s</strong>.<br /><br />Обратитесь к %2$sадминистратору конференции%3$s за дополнительной информацией.',
	...
	'EXTENSION_DISABLED_AFTER_POSTING'	=> 'Расширение <strong>%s</strong> было запрещено, вложение больше не доступно.',
