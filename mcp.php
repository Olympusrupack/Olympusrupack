...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Для добавления отзыва, пожалуйста, заполните следующую форму. Используйте только обычный текст; HTML, BBCode и пр. не разрешены.',
	'ADD_WARNING'			=> 'Вынести предупреждение',
	'ADD_WARNING_EXPLAIN'	=> 'Для отправки предупреждения этому пользователю, пожалуйста, заполните следующую форму. Используйте только обычный текст; HTML, BBCode и пр. не разрешены.',
	...
	'FEEDBACK'				=> 'Отзывы о пользователе',
	'FORK'					=> 'Создать копию',
	...
	'LATEST_WARNING_TIME'		=> 'Последнее вынесенное предупреждение',
	...
	'LOOKUP_ALL'				=> 'Просмотреть хосты для всех IP адресов',
	'LOOKUP_IP'					=> 'Просмотреть хост для IP адреса',
	...
	'MCP_MAKE_ANNOUNCEMENT'			=> 'Создать объявление',
	'MCP_MAKE_ANNOUNCEMENT_CONFIRM'	=> 'Вы уверены, что хотите сделать эту тему объявлением?',
	'MCP_MAKE_ANNOUNCEMENTS'		=> 'Создать объявления',
	'MCP_MAKE_ANNOUNCEMENTS_CONFIRM'=> 'Вы уверены, что хотите сделать выбранные темы объявлениями?',
	'MCP_MAKE_GLOBAL'				=> 'Создать общее объявление',
	'MCP_MAKE_GLOBAL_CONFIRM'		=> 'Вы уверены, что хотите сделать эту тему общим объявлением?',
	'MCP_MAKE_GLOBALS'				=> 'Создать общие объявления',
	'MCP_MAKE_GLOBALS_CONFIRM'		=> 'Вы уверены, что хотите сделать выбранные темы общими объявлениями?',
	'MCP_MAKE_STICKY'				=> 'Создать прилепленную тему',
	'MCP_MAKE_STICKY_CONFIRM'		=> 'Вы уверены, что хотите сделать эту тему прилепленной?',
	'MCP_MAKE_STICKIES'				=> 'Создать прилепленные темы',
	'MCP_MAKE_STICKIES_CONFIRM'		=> 'Вы уверены, что хотите сделать выбранные темы прилепленными?',
	'MCP_MAKE_NORMAL'				=> 'Создать обычную тему',
	'MCP_MAKE_NORMAL_CONFIRM'		=> 'Вы уверены, что хотите сделать эту тему обычной?',
	'MCP_MAKE_NORMALS'				=> 'Создать обычные темы',
	...
	'MCP_REPORTS_OPEN_EXPLAIN'		=> 'Это список всех жалоб на сообщения, которые еще не были рассмотрены',
	...
	'NOTIFY_POSTER_DISAPPROVAL'		=> 'Уведомить автора о отклонении его сообщения?',
	...
	'NO_FEEDBACK'					=> 'Нет отзывов об этом пользователе',
	...
	'POST_LOCKED_SUCCESS'		=> 'Сообщение успешно закрыто',
	...
	'POST_UNLOCKED_SUCCESS'		=> 'Сообщение успешно открыто',

	'READ_USERNOTES'			=> 'Заметки о пользователе',
	...
	'REPORTS_TOTAL'				=> 'Всего имеется <strong>%d</strong> жалоб для просмотра',
	'REPORTS_ZERO_TOTAL'		=> 'Отсутствуют жалобы для просмотра',
	'REPORT_CLOSED'				=> 'Эта жалоба ранее была закрыта.',
	'REPORT_CLOSED_SUCCESS'		=> 'Выбранная жалоба была успешно закрыта.',
	'REPORT_DELETED_SUCCESS'	=> 'Выбранная жалоба была успешно удалена.',
	'REPORT_DETAILS'			=> 'Информация об жалобе',
	'REPORT_MESSAGE'			=> 'Отправить жалобу на это сообщение',
	'REPORT_MESSAGE_EXPLAIN'	=> 'Используйте эту форму для отправки жалобы на выбранное сообщение администраторам форума. Жалобы обычно используются только в случаях, когда сообщение нарушает правила форума.',
	'REPORT_NOTIFY'				=> 'Уведомлять меня',
	'REPORT_NOTIFY_EXPLAIN'		=> 'Информировать вас о рассмотрении вашей жалобы',
	...
	'REPORT_TOTAL'				=> 'Всего имеется <strong>1</strong> жалоб для просмотра',
	'RESYNC'					=> 'Синхронизировать',
	'RETURN_MESSAGE'			=> '%sВернуться к сообщению%s',
	'RETURN_NEW_FORUM'			=> '%sВернуться к новому форуму%s',
	'RETURN_NEW_TOPIC'			=> '%sВернуться к новой теме%s',
	...
	'USER_FEEDBACK_ADDED'			=> 'Отзыв о пользователе успешно добавлен.',
